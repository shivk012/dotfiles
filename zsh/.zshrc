...
alias whd_test_integration="pytest --create-db --dc=GbrEnergyInterfaceAgnostic --ds=tests.settings  /Users/shivam.kumar/projects/kraken-core/src/tests/integration/subsystems/gbr_energy/plugins/territories/gbr/warm_home_discount"
...
td(){
    ...
    then
        shift
        todo.sh add $@ | grep '\d*\s' -m 1 -o | xargs -I '{}' todo.sh pri '{}' $first_arg
    else
        todo.sh $@
    fi
}
